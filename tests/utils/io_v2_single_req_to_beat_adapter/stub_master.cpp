...
/*
 * Single-req testbench master for IoV2SingleReqToBeatAdapter. It declares
 * signature IoV2SingleReq on its output, so binding it to an IoV2Beat stub
 * target makes the framework auto-insert the adapter between them.
 *
